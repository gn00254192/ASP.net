...
public partial class Lesson_1 : System.Web.UI.Page
{
    ...
    public void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            Image3.ImageUrl = "https://photos-3.dropbox.com/t/2/AABrek0xBdYAPFSDiJh0tE12s0GaA5prPvMSdkWahv0VLg/12/36943375/png/32x32/1/_/1/2/face.png/ENiPjRwYmjwgAigC/1IcSgbn94OVp2ONmyfY8LRBTFawGI61HO1lQRQe_GhY?size=1024x768&size_mode=2";
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        conn.Open();
        SqlCommand cmd = new SqlCommand("Insert Into Pic_score (Lesson,Test_pic,Score) Values(1," + int.Parse(Pic_ID[k-1]) + ",@paramScore)", conn);
