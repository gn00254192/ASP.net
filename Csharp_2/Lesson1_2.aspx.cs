...
public partial class Lesson1_2 : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        Image2.ImageUrl = "https://photos-4.dropbox.com/t/2/AAADMcT7ZT_8SWUfuvD5emPRrE2P3scwrrPAncCdiXozvw/12/36943375/jpeg/32x32/1/_/1/2/1416406425.JPEG/ENiPjRwY8zsgAigC/7mcP9PyuhR-QBtBXl5xeuBbYE69nsMib7Wh1zdOWjmg?size=1024x768&size_mode=2";
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        SqlCommand cmd = new SqlCommand("Insert Into Pic_score (Lesson,Test_pic,Benchmark_pic,Score) Values(1,425,531,@paramScore)", conn);
        ...
        conn.Close();
        conn.Dispose();
        Response.Redirect("Lesson1_3.aspx");
    }
}