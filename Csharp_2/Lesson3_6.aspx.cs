...
public partial class Lesson3_6 : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        Image2.ImageUrl = "https://photos-2.dropbox.com/t/2/AACFs10j8pE9hZcM4AM73d6OC3chPXeQw5ykZ5ZZGsEG3g/12/36943375/jpeg/32x32/1/_/1/2/1416485108.JPEG/ENiPjRwY_TsgAigC/i2XHKQEQ0mXG8CTF3FesWjbVOuMC-97dMMZ6-q7ESJc?size=1024x768&size_mode=2";
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        SqlCommand cmd = new SqlCommand("Insert Into Pic_score (Lesson,Test_pic,Benchmark_pic,Score) Values(3,108,254,@paramScore)", conn);
        ...
        conn.Close();
        conn.Dispose();
        Response.Redirect("Lesson3_7.aspx");
    }
}