...
public partial class Lesson2_2 : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        Image2.ImageUrl = "https://photos-2.dropbox.com/t/2/AAC0ob9sBsgkuoYUv78zsYONu70O_G8ZtIz9IRubzPdh7A/12/36943375/jpeg/32x32/1/_/1/2/1415792541.JPEG/ENiPjRwY_TsgAigC/pMv9DsSDn8jtCcUP0UuMMbuj4sEL4iVt6HYnFFxNBgw?size=1024x768&size_mode=2";
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        SqlCommand cmd = new SqlCommand("Insert Into Pic_score (Lesson,Test_pic,Benchmark_pic,Score) Values(2,541,505,@paramScore)", conn);
        ...
        conn.Close();
        conn.Dispose();
        Response.Redirect("Lesson2_3.aspx");
    }
}