...
public partial class Lesson2_5 : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        Image2.ImageUrl = "https://photos-4.dropbox.com/t/2/AAB1YFRP_n8opPcj_LeU9a-hWnLnEhN0-f_qWSD--MfKCA/12/36943375/jpeg/32x32/1/_/1/2/1415795272_1.JPEG/ENiPjRwY_TsgAigC/AsHHCtWLKKKiDdqxdRdn780zOs_hmtI-dEPFS-7SzBI?size=1024x768&size_mode=2";
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        SqlCommand cmd = new SqlCommand("Insert Into Pic_score (Lesson,Test_pic,Benchmark_pic,Score) Values(2,272,505,@paramScore)", conn);
        ...
        conn.Close();
        conn.Dispose();
        Response.Redirect("Lesson2_6.aspx");
    }
}