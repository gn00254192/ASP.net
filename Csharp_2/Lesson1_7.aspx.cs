...
public partial class Lesson1_7 : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        Image2.ImageUrl = "https://photos-1.dropbox.com/t/2/AAA7DD6BIsEPfY_clIJA3Hvpcgm1REF4aVtJL_mTF4cpuA/12/36943375/jpeg/32x32/1/_/1/2/1416406750.JPEG/ENiPjRwY8zsgAigC/snZaBHWIWvrHR1D7e3MEZug6e78Tm1WArOCv4B8NzmM?size=1024x768&size_mode=2";
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        SqlCommand cmd = new SqlCommand("Insert Into Pic_score (Lesson,Test_pic,Benchmark_pic,Score) Values(1,750,531,@paramScore)", conn);
