...
public partial class Lesson2_1 : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        Image2.ImageUrl = "https://photos-3.dropbox.com/t/2/AABSQrJPgDIgjq5M36KTbHfO-eK8nWCoS-ZhHIk9efXa3w/12/36943375/jpeg/32x32/1/_/1/2/1415792402.JPEG/ENiPjRwY_TsgAigC/Vo2AsKqAYPHDxKZj-z52b-BoQfLkhS2P51QijOcJkDc?size=1024x768&size_mode=2";
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        SqlCommand cmd = new SqlCommand("Insert Into Pic_score (Lesson,Test_pic,Benchmark_pic,Score) Values(2,402,505,@paramScore)", conn);
        ...
        conn.Close();
        conn.Dispose();
        Response.Redirect("Lesson2_2.aspx");
    }
}