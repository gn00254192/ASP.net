...
public partial class Lesson1_5 : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        Image2.ImageUrl = "https://photos-3.dropbox.com/t/2/AABqG0X7Fo3DDwmvZ2y0IgLm-dm4_p1Fky19A6lwr1RUlw/12/36943375/jpeg/32x32/1/_/1/2/1416405907.JPEG/ENiPjRwY8zsgAigC/2Zi2Tsbg1vhFNgoPp645Q5drSOLqOXDMcdJBJxaNNKM?size=1024x768&size_mode=2";
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        SqlCommand cmd = new SqlCommand("Insert Into Pic_score (Lesson,Test_pic,Benchmark_pic,Score) Values(1,907,531,@paramScore)", conn);
        ...
        conn.Close();
        conn.Dispose();
        Response.Redirect("Lesson1_6.aspx");
    }
}