...
public partial class Lesson3_4 : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        Image2.ImageUrl = "https://photos-3.dropbox.com/t/2/AACPJpVA4ZVWUtDoM7I_YrJgZdsXJR9jewqaIHobRwxJMg/12/36943375/jpeg/32x32/1/_/1/2/1416485193.JPEG/ENiPjRwY_TsgAigC/sJPsq9Arsre5Nz9d7EYL41iLfH_JKLeeTJKUZju8YEw?size=1024x768&size_mode=2";
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        SqlCommand cmd = new SqlCommand("Insert Into Pic_score (Lesson,Test_pic,Benchmark_pic,Score) Values(3,193,254,@paramScore)", conn);
        ...
        conn.Close();
        conn.Dispose();
        Response.Redirect("Lesson3_5.aspx");
    }
}