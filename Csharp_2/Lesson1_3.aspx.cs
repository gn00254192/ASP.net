...
public partial class Lesson1_3 : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        Image2.ImageUrl = "https://photos-3.dropbox.com/t/2/AABIwpY4jPbSI8wJYN3BV1yrSNKnzM10nbu9WWmXI19HeA/12/36943375/jpeg/32x32/1/_/1/2/1416406511.JPEG/ENiPjRwY8zsgAigC/0fXhXcthHng4a4Z5bH9DCH7Z9C7NIylxE2tRMue0Knc?size=1024x768&size_mode=2";
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        SqlCommand cmd = new SqlCommand("Insert Into Pic_score (Lesson,Test_pic,Benchmark_pic,Score) Values(1,511,531,@paramScore)", conn);
        ...
        conn.Close();
        conn.Dispose();
        Response.Redirect("Lesson1_4.aspx");
    }
}