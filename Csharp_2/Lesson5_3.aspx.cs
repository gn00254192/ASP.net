...
public partial class Lesson5_3 : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        Image2.ImageUrl = "https://photos-5.dropbox.com/t/2/AACmUBgjmk_TUIcS_6a6cWzvYkGdfuyQ_Q_5wqD0_lcgnw/12/36943375/png/32x32/1/_/1/2/4.png/ENiPjRwYkTwgAigC/ZiMMw5PauWWX3-v3iMLRHGMkkj1AjAiwXszG1YLIVIA?size=1024x768&size_mode=2";
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        SqlCommand cmd = new SqlCommand("Insert Into Pic_score (Lesson,Test_pic,Benchmark_pic,Score) Values(5,4,3,@paramScore)", conn);
        ...
        conn.Close();
        conn.Dispose();
        Response.Redirect("Lesson5_4.aspx");
    }
}