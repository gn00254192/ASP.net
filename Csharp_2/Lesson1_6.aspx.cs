...
public partial class Lesson1_6 : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        Image2.ImageUrl = "https://photos-4.dropbox.com/t/2/AAB3ip1WeYkVkomUfxQx-3J98J7y-OUgtXLJvhZaGQ-uAA/12/36943375/jpeg/32x32/1/_/1/2/1416405821.JPEG/ENiPjRwY8zsgAigC/Oqg7J29-6KlL8XSsrjiFDEmgZeK7yMx34981IsMofnE?size=1024x768&size_mode=2";
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        SqlCommand cmd = new SqlCommand("Insert Into Pic_score (Lesson,Test_pic,Benchmark_pic,Score) Values(1,821,531,@paramScore)", conn);
        ...
        conn.Close();
        conn.Dispose();
        Response.Redirect("Lesson1_7.aspx");
    }
}