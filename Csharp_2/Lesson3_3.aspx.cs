...
public partial class Lesson3_3 : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        Image2.ImageUrl = "https://photos-5.dropbox.com/t/2/AAAR6zm6QRp7l5L_bTP6SV5GvBnLzwWxo0SrHy1pitLT9g/12/36943375/jpeg/32x32/1/_/1/2/1416485044.JPEG/ENiPjRwY_TsgAigC/rvRyy-cesfyVNg9mMv56EUrgprAkrvjErLlD1Y4gBgw?size=1024x768&size_mode=2";
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        SqlCommand cmd = new SqlCommand("Insert Into Pic_score (Lesson,Test_pic,Benchmark_pic,Score) Values(3,44,254,@paramScore)", conn);
        ...
        conn.Close();
        conn.Dispose();
        Response.Redirect("Lesson3_4.aspx");
    }
}