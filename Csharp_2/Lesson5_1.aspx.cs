...
public partial class Lesson5_1 : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        Image2.ImageUrl = "https://photos-6.dropbox.com/t/2/AADS4R-ogkUPXRNq7ECqr_ekOjkEJBqwt0my6KPrB7mOZQ/12/36943375/png/32x32/1/_/1/2/1.png/ENiPjRwYkTwgAigC/rjGHh0xbA_rU-bfp0jsb4IocUOdSqCYAQ-FFRyx27TY?size=1024x768&size_mode=2";
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        SqlCommand cmd = new SqlCommand("Insert Into Pic_score (Lesson,Test_pic,Benchmark_pic,Score) Values(5,1,3,@paramScore)", conn);
        ...
        conn.Close();
        conn.Dispose();
        Response.Redirect("Lesson5_2.aspx");
    }
}