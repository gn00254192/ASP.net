...
public partial class Lesson5_4 : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        Image2.ImageUrl = "https://photos-6.dropbox.com/t/2/AABxm0VyYCqVUUduEattSYePzeZBnDThkt0QDnq0NElm9g/12/36943375/png/32x32/1/_/1/2/5.png/ENiPjRwYkTwgAigC/9UGdD6rwdIHrpar7rYjSl0VhF7tFuin8YgQfkg91d2Q?size=1024x768&size_mode=2";
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        SqlCommand cmd = new SqlCommand("Insert Into Pic_score (Lesson,Test_pic,Benchmark_pic,Score) Values(5,5,3,@paramScore)", conn);
        ...
        conn.Close();
        conn.Dispose();
        Response.Redirect("Lesson5_5.aspx");
    }
}