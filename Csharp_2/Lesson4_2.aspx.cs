...
public partial class Lesson4_2 : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        Image2.ImageUrl = "https://photos-5.dropbox.com/t/2/AACcZLqVUtntXCoj3y1rD-cnVyunkzCKAqjJVUr0EIoS5w/12/36943375/jpeg/32x32/1/_/1/2/1416495475.JPEG/ENiPjRwYiTwgAigC/VwtKEI3pyyrkKhe1aYb0EB9t_1G249p5ekHXM4lRSRI?size=1024x768&size_mode=2";
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        SqlCommand cmd = new SqlCommand("Insert Into Pic_score (Lesson,Test_pic,Benchmark_pic,Score) Values(4,475,507,@paramScore)", conn);
        ...
        conn.Close();
        conn.Dispose();
        Response.Redirect("Lesson4_3.aspx");
    }
}