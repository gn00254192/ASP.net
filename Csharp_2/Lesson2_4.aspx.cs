...
public partial class Lesson2_4 : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        Image2.ImageUrl = "https://photos-1.dropbox.com/t/2/AAC2ZqVP_VoNcCPQljll70Z0yP5-gV72A2ajejpoJyDVrw/12/36943375/jpeg/32x32/1/_/1/2/1415792470.JPEG/ENiPjRwY_TsgAigC/4skjdL3TA61YlGUktJ5BL1cEmphdtwjh8aPlngmTFJI?size=1024x768&size_mode=2";
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        SqlCommand cmd = new SqlCommand("Insert Into Pic_score (Lesson,Test_pic,Benchmark_pic,Score) Values(2,470,505,@paramScore)", conn);
        ...
        conn.Close();
        conn.Dispose();
        Response.Redirect("Lesson2_5.aspx");
    }
}