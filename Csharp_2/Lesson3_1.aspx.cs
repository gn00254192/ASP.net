...
public partial class Lesson3_1 : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        Image2.ImageUrl = "https://photos-2.dropbox.com/t/2/AADlhgHR4mPHZtd63TMY_vzt8d_jsUW1spSmghRJAbwchg/12/36943375/jpeg/32x32/1/_/1/2/1416485011.JPEG/ENiPjRwY_TsgAigC/SnY8SphbSAcNUoP5SeZWdDId1kmQ108mfOVTJRwmDNg?size=1024x768&size_mode=2";
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        SqlCommand cmd = new SqlCommand("Insert Into Pic_score (Lesson,Test_pic,Benchmark_pic,Score) Values(3,11,254,@paramScore)", conn);
        ...
        conn.Close();
        conn.Dispose();
        Response.Redirect("Lesson3_2.aspx");
    }
}