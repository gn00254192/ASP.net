...
public partial class Lesson2_6 : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        Image2.ImageUrl = "https://photos-2.dropbox.com/t/2/AABcscdPM7UJyGovnwU0AE9PgJKCW2uh-FZ6e5rHpKlW6g/12/36943375/jpeg/32x32/1/_/1/2/1415792556.JPEG/ENiPjRwY_zsgAigC/438XTG-T-ySKX8OO8FQBFAi8N24BTx_A0PmpuEZfmno?size=1024x768&size_mode=2";
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        SqlCommand cmd = new SqlCommand("Insert Into Pic_score (Lesson,Test_pic,Benchmark_pic,Score) Values(2,556,505,@paramScore)", conn);
        ...
        conn.Close();
        conn.Dispose();
        Response.Redirect("Lesson2_7.aspx");
    }
}