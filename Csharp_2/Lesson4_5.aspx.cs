...
public partial class Lesson4_5 : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        Image2.ImageUrl = "https://photos-2.dropbox.com/t/2/AAAWpUhFNCqpOg71m5t5ZFbR2u5jqmct2KV8Kkjl7-97Hg/12/36943375/jpeg/32x32/1/_/1/2/1416495833.JPEG/ENiPjRwYiTwgAigC/RvGj-1dcjqjeUG8Dwy6sCnVFdzMaXD6m4Q2j3x1L-10?size=1024x768&size_mode=2";
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        SqlCommand cmd = new SqlCommand("Insert Into Pic_score (Lesson,Test_pic,Benchmark_pic,Score) Values(4,833,507,@paramScore)", conn);
        ...
        conn.Close();
        conn.Dispose();
        Response.Redirect("Lesson4_6.aspx");
    }
}