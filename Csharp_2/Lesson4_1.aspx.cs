...
public partial class Lesson4_1 : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        Image2.ImageUrl = "https://photos-1.dropbox.com/t/2/AABo19_A2Bzdfx1Dx6EgaWV4wl8yxHDwdiQNeqzu62eLdg/12/36943375/jpeg/32x32/1/_/1/2/1416496275.JPEG/ENiPjRwYiTwgAigC/okHz4SIKeSBajcHCavUUX3MPghzoSRebvtd2cr-Mel0?size=1024x768&size_mode=2";
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        SqlCommand cmd = new SqlCommand("Insert Into Pic_score (Lesson,Test_pic,Benchmark_pic,Score) Values(4,275,507,@paramScore)", conn);
        ...
        conn.Close();
        conn.Dispose();
        Response.Redirect("Lesson4_2.aspx");
    }
}